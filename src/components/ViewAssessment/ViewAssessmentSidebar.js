...
const ViewAssessmentSidebar = ({ org, assessments, currentUser }) => {
  console.log("org", org);
      ...
      <div className="sidebar-container-text">
        ...
        <div className="sidebar-item">
          ...
          <a href="/organization-management" style={{ textDecoration: "none" }}>
            <h1 className="item">View Assessment</h1>
          </a>
        </div>
        <div className="sidebar-item">
          <div className="svg-icon">
          ...
          <a href="/view-candidate" style={{ textDecoration: "none" }}>
            <h1 className="item">view candidate</h1>
          </a>
        </div>
      </div>
    </div>
...
export default ViewAssessmentSidebar;
