                  ...
                  (
                    ...
                    <tr key={i}>
                      ...
                      <td className="text-nowrap pr-2 pl-2">
                        ...
                        {data.recordStatus.value != null && (
                          <>
                            <div className="heading_bold" key={i}>
                              startMinute -{" "}
                              {_get(data, "startMinute.value", "")}
                            </div>
                            <div className="heading_bold" key={i}>
                              dayOfWeek - {_get(data, "dayOfWeek.value", "")}
                            </div>
                            <div className="heading_bold" key={i}>
                              teacherId - {_get(data, "teacherId.value", "")}
                            </div>
                          </>
                        )}
                      </td>
